...
<div class="container container-fluid">
  ...
  <div class="page-header">
    <h1><i class="glyphicon glyphicon-star"></i><?php echo i18n::__('credential') ?></h1>
  </div>
...
<?php foreach ($objCredencial as $credencial): ?>
          <tr>
            ...
            <td>
              ...
              <a href="#" class="btn btn-info btn-xs"><i class="glyphicon glyphicon-eye-open" data-toggle="popover" title="Ver" data-content="Datos de Credencial"></i></a>
              <a href="<?php echo routing::getInstance()->getUrlWeb('credencial', 'edit', array(credencialTableClass::ID => $credencial->$id)) ?>" class="btn btn-warning btn-xs" data-toggle="popover" title="Editar" data-content="Edicion de Credencial"><i class="glyphicon glyphicon-pencil"></i></a>
              <a href="#" onclick="confirmarEliminar(<?php echo $credencial->$id ?>)" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash" data-toggle="popover" title="Borrar" data-content="Eliminar Credencial"></i></a>
            </td>
          </tr>
<?php endforeach ?>
      </tbody>
  ...
  <div style="margin-bottom: 10px; margin-top: 30px" align="center">
    ...
    <a href="<?php echo routing::getInstance()->getUrlWeb('credencial', 'insert') ?>" class="btn btn-success" data-toggle="popover" title="Nueva Credencial" data-content="Creacion de Credencial"><i class="glyphicon glyphicon-plus"></i><i class="glyphicon glyphicon-star"></i></a>
