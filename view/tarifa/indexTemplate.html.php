...
<div class="container container-fluid">
  ...
  <div class="page-header">
    <h1><i class="glyphicon glyphicon-yen"></i><?php echo i18n::__('rates') ?></h1>
  </div>
...
<?php foreach ($objTarifa as $tarifa): ?>
          <tr>
            ...
            <td>
              ...
              <a href="<?php echo routing::getInstance()->getUrlWeb('tarifa', 'edit', array(tarifaTableClass::ID => $tarifa->$id)) ?>" class="btn btn-warning btn-xs" data-toggle="popover" title="Editar" data-content="edicion de usuario"><i class="glyphicon glyphicon-pencil"></i></a>
              <a href="#" onclick="confirmarEliminar(<?php echo $tarifa->$id ?>)" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash" data-toggle="popover" title="Borrar" data-content="Eliminar usuario"></i></a>
            </td>
          </tr>
<?php endforeach ?>
      </tbody>
  ...
  <div style="margin-bottom: 10px; margin-top: 30px" align="center">
    ...
    <a href="<?php echo routing::getInstance()->getUrlWeb('tarifa', 'insert') ?>" class="btn btn-success" data-toggle="popover" title="Crear Nuevo Usuario" data-content="creacion de usuario"><i class="glyphicon glyphicon-plus"></i><i class="glyphicon glyphicon-user"></i></a>
