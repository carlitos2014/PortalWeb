...
<div class="container container-fluid">
  ...
  <div class="page-header">
    <h1><i class="glyphicon glyphicon glyphicon-globe"></i><?php echo i18n::__('eventPlaceManagement') ?></h1>
  </div>
        ...
        <?php foreach ($objLocalidad as $localidad): ?>
          <tr>
            ...
            <td>
              ...
              <a href="#" class="btn btn-info btn-xs"><i class="glyphicon glyphicon-eye-open" data-toggle="popover" title="Ver" data-content="Datos De Localidad"></i></a>
              <a href="<?php echo routing::getInstance()->getUrlWeb('localidad', 'edit', array(localidadTableClass::ID => $localidad->$id)) ?>" class="btn btn-warning btn-xs" data-toggle="popover" title="Editar" data-content="Edicion De Localidad"><i class="glyphicon glyphicon-pencil"></i></a>
              <a href="#" onclick="confirmarEliminar(<?php echo $localidad->$id ?>)" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash" data-toggle="popover" title="Borrar" data-content="Eliminar Localidad"></i></a>
            </td>
          </tr>
        <?php endforeach ?>
      </tbody>
  ...
  <div style="margin-bottom: 10px; margin-top: 30px" align="center">
    ...
    <a href="<?php echo routing::getInstance()->getUrlWeb('localidad', 'insert') ?>" class="btn btn-success" data-toggle="popover" title="Crear Nueva Localidad" data-content="Creacion De Localidad"><i class="glyphicon glyphicon-plus"></i><i class="glyphicon glyphicon-globe"></i></a>
