...
<div id="content">
    ...
    <div id="right">
        ...
        <div style="margin-bottom: 10px; margin-top: 30px" align="center">
            <a href="www.facebook.com" target="_black" class="btn btn-facebook " data-toggle="popover" title="Facebook" data-content="Facebook"><i class="glyphicon fa fa-facebook"></i></a>
            <a href="www.twitter.com" target="_black" class="btn btn-twitter " data-toggle="popover" title="Twitter" data-content="Twitter"><i class="glyphicon fa fa-twitter"></i></a>
