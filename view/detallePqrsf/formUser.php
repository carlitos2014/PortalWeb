    ...
    <form class="form-create" role="form" action="<?php echo routing::getInstance()->getUrlWeb('detallePqrsf', 'create') ?>" method="POST">
        ...
        <div class="form-group" <?php echo (session::getInstance()->hasFlash(detallePqrsTableClass::getNameField(detallePqrsTableClass::PQRS_ID, TRUE)) === TRUE) ? 'has-error has-feedback' : '' ?>>
            ...
            <div class="col-sm-10">
                ...
                <select class="form-control" name="<?php echo detallePqrsTableClass::getNameField(detallePqrsTableClass::ID, true) ?>" id="<?php echo detallePqrsTableClass::getNameField(detallePqrsTableClass::ID, true) ?>">
                    <option value=""><?php echo i18n::__('feedback_select') ?></option>
                    <?php foreach ($objtipoPqrsf as $dato1): ?> 
                        <option value="<?php echo $dato1->id ?>"><?php echo $dato1->id . " " . $dato1->nombre ?></option>
