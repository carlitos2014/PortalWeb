...
<div class="container container-fluid">
  ...
  <div class="page-header">
    <h1><i class="glyphicon glyphicon-briefcase"></i>&nbsp;<?php echo i18n::__('partner') ?></h1>
  </div>
        ...
        <?php foreach ($objPatrocinador as $patrocinador): ?>
          <tr>
            ...
            <td>
              ...
              <a href="#" class="btn btn-info btn-xs"><i class="glyphicon glyphicon-eye-open" data-toggle="popover" title="Ver" data-content="Datos de Patrocinador"></i></a>
              <a href="<?php echo routing::getInstance()->getUrlWeb('patrocinador', 'edit', array(patrocinadorTableClass::ID => $patrocinador->$id)) ?>" class="btn btn-warning btn-xs" data-toggle="popover" title="Editar" data-content="Edicion de Patrocinador"><i class="glyphicon glyphicon-pencil"></i></a>
              <a href="#" onclick="confirmarEliminar(<?php echo $patrocinador->$id ?>)" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash" data-toggle="popover" title="Borrar" data-content="Eliminar Patrocinador"></i></a>
            </td>
          </tr>
        <?php endforeach ?>
      </tbody>
  ...
  <div style="margin-bottom: 10px; margin-top: 30px" align="center">
    ...
    <a href="<?php echo routing::getInstance()->getUrlWeb('patrocinador', 'insert') ?>" class="btn btn-success" data-toggle="popover" title="Crear Nuevo Patrocinador" data-content="Creacion de Patrocinador"><i class="glyphicon glyphicon-plus"></i><i class="glyphicon glyphicon-briefcase"></i></a>
