...
<div class="container container-fluid">
  ...
  <div class="page-header">
    <h1><i class="glyphicon glyphicon-thumbs-up"></i><i class="glyphicon glyphicon-thumbs-down"></i><?php echo i18n::__('feedback') ?></h1>
  </div>
...
<?php endforeach ?>
  ...
  <div style="margin-bottom: 10px; margin-top: 30px" align="center">
    ...
    <a href="<?php echo routing::getInstance()->getUrlWeb('pqrsf', 'insert') ?>" class="btn btn-success" data-toggle="popover" title="Crear nuevo Pqrsf" data-content="Creacion de Pqrsf"><i class="glyphicon glyphicon-plus"></i><i class="glyphicon glyphicon-thumbs-up"></i><i class="glyphicon glyphicon-thumbs-down"></i></a>
