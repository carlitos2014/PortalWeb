...
<form class="form-create" role="form" action="<?php echo routing::getInstance()->getUrlWeb('evento', 'create') ?>" method="POST">
    ...
    <div class="form-group" <?php echo (session::getInstance()->hasFlash(eventoTableClass::getNameField(eventoTableClass::DESCRIPCION, TRUE)) === TRUE) ? 'has-error has-feedback' : '' ?>>
      ...
      <div class="col-sm-10">
        <input type="text" id="<?php echo eventoTableClass::getNameField(eventoTableClass::DESCRIPCION, true) ?>" name="<?php echo eventoTableClass::getNameField(eventoTableClass::DESCRIPCION, true) ?>" class="form-control" placeholder="<?php echo i18n::__('description') ?>" >
    ...
    <div class="form-group" <?php echo (session::getInstance()->hasFlash(eventoTableClass::getNameField(eventoTableClass::LUGAR_LATITUD, TRUE)) === TRUE) ? 'has-error has-feedback' : '' ?>>
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" placeholder="<?php echo i18n::__('latitude') ?>"  name="<?php echo eventoTableClass::getNameField(eventoTableClass::LUGAR_LATITUD, true) ?>" id="<?php echo eventoTableClass::getNameField(eventoTableClass::LUGAR_LATITUD, true) ?>" value="<?php echo (session::getInstance()->hasFlash(eventoTableClass::getNameField(eventoTableClass::LUGAR_LATITUD, TRUE)) === TRUE) ? request::getInstance()->getPost(eventoTableClass::getNameField(eventoTableClass::LUGAR_LATITUD, TRUE)) : '' ?>">
...
<div class="form-group" <?php echo (session::getInstance()->hasFlash(eventoTableClass::getNameField(eventoTableClass::LUGAR_LONGITUD, TRUE)) === TRUE) ? 'has-error has-feedback' : '' ?>>
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" placeholder="<?php echo i18n::__('longitude') ?>"  name="<?php echo eventoTableClass::getNameField(eventoTableClass::LUGAR_LONGITUD, true) ?>" id="<?php echo eventoTableClass::getNameField(eventoTableClass::LUGAR_LONGITUD, true) ?>" value="<?php echo (session::getInstance()->hasFlash(eventoTableClass::getNameField(eventoTableClass::LUGAR_LONGITUD, TRUE)) === TRUE) ? request::getInstance()->getPost(eventoTableClass::getNameField(eventoTableClass::LUGAR_LONGITUD, TRUE)) : '' ?>">
...
<div class="form-group" <?php echo (session::getInstance()->hasFlash(eventoTableClass::getNameField(eventoTableClass::DIRECCION, TRUE)) === TRUE) ? 'has-error has-feedback' : '' ?>>
    ...
    <div class="form-group" <?php echo (session::getInstance()->hasFlash(eventoTableClass::getNameField(eventoTableClass::USUARIO_ID, TRUE)) === TRUE) ? 'has-error has-feedback' : '' ?>>
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" placeholder="<?php echo i18n::__('user_id') ?>"  name="<?php echo eventoTableClass::getNameField(eventoTableClass::USUARIO_ID, true) ?>" id="<?php echo eventoTableClass::getNameField(eventoTableClass::USUARIO_ID, true) ?>" value="<?php echo (session::getInstance()->hasFlash(eventoTableClass::getNameField(eventoTableClass::USUARIO_ID, TRUE)) === TRUE) ? request::getInstance()->getPost(eventoTableClass::getNameField(eventoTableClass::USUARIO_ID, TRUE)) : '' ?>">
